...
xnoremap <Leader>b; gc
nnoremap <Leader>b; gcc

noremap <Leader>bb :<C-u>Buffers<CR>
noremap <Leader>bd :<C-u>bdelete<CR>
noremap <Leader>bY m`ggyG``
noremap <Leader>bn :<C-u>bnext<CR>
noremap <Leader>bp :<C-u>bprev<CR>
" noremap <Leader>be :<C-u>Delete<CR>

noremap <Leader>feR :<C-u>source $MYVIMRC<CR>
noremap <Leader>feU :<C-u>PlugUpdate<CR>
noremap <Leader>fed :<C-u>edit $MYVIMRC<CR>
noremap <Leader>ff :<C-u>Files<CR>
noremap <Leader>fs :<C-u>update<CR>
noremap <Leader>ft :<C-u>NERDTreeToggle<CR>
