...
bind(meh, "1", function() hs.eventtap.keyStroke({"ctrl"}, "1") end)
bind(meh, "2", function() hs.eventtap.keyStroke({"ctrl"}, "2") end)
bind(meh, "3", function() hs.eventtap.keyStroke({"ctrl"}, "3") end)
bind(meh, "4", function() hs.eventtap.keyStroke({"ctrl"}, "4") end)
bind(meh, "5", function() hs.eventtap.keyStroke({"ctrl"}, "5") end)
bind(meh, "6", function() hs.eventtap.keyStroke({"ctrl"}, "6") end)
bind(meh, "7", function() hs.eventtap.keyStroke({"ctrl"}, "7") end)
bind(meh, "8", function() hs.eventtap.keyStroke({"ctrl"}, "8") end)
bind(meh, "9", function() hs.eventtap.keyStroke({"ctrl"}, "9") end)
bind(meh, "0", function() hs.eventtap.keyStroke({"ctrl"}, "0") end)
