...
let
  sources = {
    ...
    # TODO: Use `fetchFromGitHub` once repo goes public
    # "coconut-kak" =
    #   let
    #     owner = "evanrelf";
    #     repo = "coconut.kak";
    #     rev = "cc9b4d817555d80db6e333950c9c04c78d037dd7";
    #   in
    #   builtins.fetchGit {
    ...
    "git-revise-kak" = final.fetchFromGitHub {
      owner = "evanrelf";
      repo = "git-revise.kak";
    ...
    "parinfer-rust" = final.fetchFromGitHub {
      owner = "eraserhd";
      repo = "parinfer-rust";
