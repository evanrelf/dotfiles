...
printf "%s\n" "
declare-option str column_color $base3
...
set-face global LineNumbersWrapped $(c $base0 default)
set-face global BufferPadding      $(c $base0 default)
set-face global MatchingChar       $(c default $light_yellow)
set-face global PrimaryCursor      $(c $white $blue F)
set-face global PrimaryCursorEol   $(c default $blue F)
set-face global PrimarySelection   $(c default $light_blue F)
set-face global SecondaryCursor    $(c $white $yellow F)
set-face global SecondaryCursorEol $(c default $yellow F)
set-face global SecondarySelection $(c default $light_yellow F)
set-face global StatusCursor       $(c default $black F)
