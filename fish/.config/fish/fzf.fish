if _exists fzf
    ...
    set --export FZF_DEFAULT_OPTS "--color=light --exact --height $FZF_TMUX_HEIGHT --reverse --ansi"
    ...
    set --export FZF_CD_COMMAND "fd --type directory --follow"
    set --export FZF_CD_WITH_HIDDEN_COMMAND "$FZF_CD_COMMAND --hidden --exclude '.git'"
